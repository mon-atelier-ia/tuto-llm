"""Rebuild NB01 with pedagogical structure: welcome cell, explicit exercises, empty cells."""
...
def build_nb01() -> list[dict]:
    """Build the new cell list for NB01."""
    cells = []
    ...
    # === CELL 11: Exercise 3 student code ===
    cells.append(
        make_code(
    ...
    # === CELL 17: Exercise 4 student code ===
    cells.append(
        make_code(
    ...
    cells.append(
        make_md(
            ...
            "### Sources (ISO 42001)\n"
            "\n"
            "- **Concept de bigrammes et modeles de langage** : "
            "[microgpt.py](https://gist.github.com/karpathy/8627fe009c40f57531cb18360106ce95)"
            " -- Andrej Karpathy\n"
            "- **Approche pedagogique character-level** : "
            '[Video "Let\'s build GPT"](https://www.youtube.com/watch?v=kCc8FmEb1nY)'
            " -- Andrej Karpathy (2023)\n"
            "- **Visualisation des reseaux de neurones** : "
            "[3Blue1Brown - Neural Networks]"
            "(https://www.youtube.com/playlist?list=PLZHQObOWTQDNU6R1_67000Dx_ZCJB-3pi)"
            " -- Grant Sanderson\n"
            "- **Dataset Pokemon** : (c) Nintendo / Creatures Inc. / GAME FREAK inc., "
            "usage educatif. Source : [PokeAPI](https://pokeapi.co/)"
        )
    )
...
def main():
    ...
    print(f"NB01 rebuilt: {len(nb['cells'])} cells ({md_count} md + {code_count} code)")
    print("  Exercises: 4 (with dedicated empty/editable cells)")
    print("  Welcome cell with Jupyter instructions: yes")
